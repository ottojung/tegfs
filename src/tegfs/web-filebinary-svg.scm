...
(cond-expand
 (guile
  (define-module (tegfs web-filebinary-svg)
    :export (web::filebinary.svg)
    :use-module ((tegfs web-define-static-file) :select (web::define-static-file))
    )))

(define web::filebinary.svg::string
...
<svg
  ...
  <g
      ...
      transform='translate(-5.2771 -.50876)'
    >
    <path
        id='path2930'
        style='fill:url(#linearGradient3070)'
  ...
  <metadata
    ...
    <rdf:RDF
      ...
      <cc:Work
        ...
        >
        <dc:title
          >Binary File</dc:title
        >
        <dc:date
          >2010-04-21T12:27:30</dc:date
        >
        <dc:description
          >A remix of Anonymous' Spreadsheet Icon. It shows a binary file. </dc:description
        >
        <dc:source
          >https://openclipart.org/detail/49411/binary-file-by-mihi</dc:source
        >
        <dc:creator
          >
          <cc:Agent
